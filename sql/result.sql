INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select *
...
where 1 = 1
order by temp.订单类型, temp.订单导入时间, temp.OrderID','22年10月1日之后未分单数据','22年10月1日之后未分单数据','chenkailiang@gigacloudtech.com','liuchao@gigacloudtech.com,shenzhenxing@gigacloudtech.com,sujiawei@gigacloudtech.com,zhaijianfeng@gigacloudtech.com,its@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select twe.warehouseCode,convert(varchar(10), max(created_date_time),120) latestSyncDate
...
order by twe.warehouseCode','WMS库存及库位数据未及时同步到DRP','WMS库存及库位数据未及时同步到DRP','chenkailiang@gigacloudtech.com,liuchao@gigacloudtech.com,lizhenbiao@gigacloudtech.com','wanyuanqi@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select
                       tor.PayPalTxID,
                       tor.OrderDate,
                       tod.ItemCode,
                   ...
                   ','【重要】大健云BO订单','【重要】大健云BO订单','csr_giga@gigacloudtech.com','liuchao@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select
                                                                                tos.orderDate
                                                                            ...
                                                                            order by  tos.storeID','【WOS-监控】大健云 New Order And OnHold 订单','【WOS-监控】大健云 New Order And OnHold 订单','csr_giga@gigacloudtech.com','chenkailiang@gigacloudtech.com,liuchao@gigacloudtech.com,chenhuizhu@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tul.orderId,
       CASE tul.worktype
...
','【WOS-监控】大健云buy label失败
','csr_giga@gigacloudtech.com','songyinghui@gigacloudtech.com,xiafei@gigacloudtech.com,liuchao@gigacloudtech.com,sujiawei@gigacloudtech.com,zhaijianfeng@gigacloudtech.com,liniannian@gigacloudtech.com,shiyuanyuan@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select distinct ts.StoreName,
                tos.OrderDate,
                ts.StorePrefix + ''-'' + CONVERT(varchar(50), tos.orderNumber) as OrderNumber,
...
where tss.Carrier = 7
  ...
  and convert(varchar(100), tss.ShipDate, 110) = convert(varchar(100), getdate(), 110)','【重要】-如下超大件订单请检查运单号是否上传到销售平台','【重要】-如下超大件订单请检查运单号是否上传到销售平台','dongqiuqun@gigacloudtech.com,gaoxianglan@gigacloudtech.com,suzhou_CSR@gigacloudtech.com','liuchao@gigacloudtech.com,xiafei@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tse.DisplayName,
       tul.orderId,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','fzsales1@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tse.DisplayName,
       tul.orderId,
       max(convert(varchar, tul.creationdate, 20)) AS dealTime,
       ''Buy FedEx Label''                           AS workname,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','【Noble监控】【重要】FedEx、UPS、Amazon Buy Label 失败 - DRP','【Noble监控】【重要】FedEx、UPS、Amazon Buy Label 失败 - DRP','fzsales2@gigacloudtech.com','drp_us_it@gigacloudtech.com,yuebeibei@gigacloudtech.com,uswhcoordinator@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tse.DisplayName,
       tul.orderId,
       max(convert(varchar, tul.creationdate, 20)) AS dealTime,
       ''Buy FedEx Label''                           AS workname,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','fzsales3@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tse.DisplayName,
       tul.orderId,
       max(convert(varchar, tul.creationdate, 20)) AS dealTime,
       ''Buy FedEx Label''                           AS workname,
...
where tul.worktype in (19)
  ...
  and DATEPART(hour, getdate()) in (23, 0, 1)
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','fzsales4@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tse.DisplayName,
       tul.orderId,
       max(convert(varchar, tul.creationdate, 20)) AS dealTime,
       ''Buy FedEx Label''                           AS workname,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','fzsales5@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tse.DisplayName,
       tul.orderId,
       max(convert(varchar, tul.creationdate, 20)) AS dealTime,
       ''Buy FedEx Label''                           AS workname,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','fzsales6@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tse.DisplayName,
       case
...
order by tbot.UpdatedDate desc, twe.warehouseCode, PayPalTxID','每日盘点美国仓库BO数据','每日盘点美国仓库BO数据','its@gigacloudtech.com,wuyating@gigacloudtech.com,uswhcoordinator@gigacloudtech.com','liuchao@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select business_type,
...
where t.business_type <> ''b2bcloudwh_sum''
order by t.sort, t.business_type','【WOS-监控】【CA时间19点】美国仓库待发单统计','【WOS-监控】【CA时间19点】美国仓库待发单统计','larry_wu@gigacloudtech.com,haoxinyan@gigacloudtech.com,wanxin@gigacloudtech.com,wangyan@gigacloudtech.com,mabin@gigacloudtech.com,xukunming@gigacloudtech.com,lunjia.li@gigacloudtech.com,wang.xin@gigacloudtech.com,stella.tian@gigacloudtech.com','mingdi.zhang@gigacloudtech.com,lei.yan@gigacloudtech.com,wenbo.dou@gigacloudtech.com,chris.xu@gigacloudtech.com,uswarehouse@gigacloudtech.com,shishanshan@gigacloudtech.com,uswhcoordinator@gigacloudtech.com,logistics@gigacloudtech.com,yuanwen@gigacloudtech.com,zhanghanlin@gigacloudtech.com,zhanghuiwen@gigacloudtech.com,xiafei@gigacloudtech.com,liuchao@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select business_type,
       isnull(CarrierCode, '''') as Carrier,
       CA2,
       CA3,
...
from (SELECT wsv.sort,
      ...
      FROM (select ''all''                 business_type,
            ...
            from (select t.warehouseCode,
                  ...
                  group by t.warehouseCode, t.CarrierCode) t PIVOT (SUM(t.qty) FOR [WarehouseCode] IN ("CA2","CA3","CA4","CA5","CA6","CA7","CA8","CA9","CA10","CA11","CAL2","CAN1","CAN2","CAN3","NJ2","NJ3","NJ4","AT1","AT2","AT3","AT4","AT5","ATN1","TX1","CANADAH1")) AS T) wsv) t
where t.business_type <> ''b2bcloudwh_sum''
order by t.sort, t.business_type','【WOS-监控】【CA时间2点AM】美国仓库待发单统计','【WOS-监控】【CA时间2点AM】美国仓库待发单统计','larry_wu@gigacloudtech.com,haoxinyan@gigacloudtech.com,wanxin@gigacloudtech.com,wangyan@gigacloudtech.com,mabin@gigacloudtech.com,xukunming@gigacloudtech.com,lunjia.li@gigacloudtech.com,wang.xin@gigacloudtech.com,stella.tian@gigacloudtech.com','mingdi.zhang@gigacloudtech.com,lei.yan@gigacloudtech.com,wenbo.dou@gigacloudtech.com,chris.xu@gigacloudtech.com,uswarehouse@gigacloudtech.com,shishanshan@gigacloudtech.com,uswhcoordinator@gigacloudtech.com,logistics@gigacloudtech.com,yuanwen@gigacloudtech.com,zhanghanlin@gigacloudtech.com,zhanghuiwen@gigacloudtech.com,xiafei@gigacloudtech.com,liuchao@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tsp.Description as description,
 ...
 where tsp.id = 8
   and tst.STATUS = 3
   and tst.CreateTime > getdate()-1','【WOS-监控】【监测】中间件接口同步失败','【WOS-监控】【监测】中间件接口同步失败','liuchao@gigacloudtech.com','xiafei@gigacloudtech.com,liuchao@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select t.OrderId,t.PO,t.Line from tblWalmartOrderTemp t group by t.OrderId,t.PO,t.Line having count(*)>1','【WOS-监控】[重要]Walmart临时表订单重复报警','【WOS-监控】[重要]Walmart临时表订单重复报警','liuchao@gigacloudtech.com','chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('-- fedex
-- 上门取货买单
...
where tc.create_date_time > getdate() - 1
  ...
  and tc.store_id = 199
  and (mw.upsCarrierId != tf.carrier_id or tf.shipper_type = ''Comptree'' or tf.pay_account_number is null
    )','DRP系统买单账号使用异常统计','DRP系统买单账号使用异常统计','liuchao@gigacloudtech.com','chenkailiang@gigacloudtech.com,xiafei@gigacloudtech.com,chenhuizhu@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select toi.sales_order_number,
       tor.OrderID,
...
where toi.data_source = ''B2B''
  ...
  and toi.create_date_time > DATEADD(HOUR, -1, GETDATE())','【DRP监控】B2B取消/拦截接口返回失败','【DRP监控】B2B取消/拦截接口返回失败','liuchao@gigacloudtech.com,chenkailiang@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('SELECT t.sales_order_number, t.sku
...
WHERE t.temp_qty <> f.yzc_qty','【DRP监控】订单统一临时表与B2B临时表明细数量不一致监控','【DRP监控】订单统一临时表与B2B临时表明细数量不一致监控','liuchao@gigacloudtech.com,chenkailiang@gigacloudtech.com,liniannian@gigacloudtech.com','chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('SELECT t.sales_order_number, t.sku
FROM (SELECT store_id, sales_order_number, toid.item_code + ''-001'' sku, SUM(toid.item_qty) AS intercept_qty
     ...
     ON t.store_id = i.store_id AND t.sales_order_number = i.sales_order_number AND t.sku = i.sku
         JOIN (SELECT tor.storeId store_id, tor.PayPalTxID sales_order_number, tod.ItemCode sku, SUM(qty) AS formal_qty
              ...
              ON t.store_id = f.store_id AND t.sales_order_number = f.sales_order_number AND t.sku = f.sku
WHERE t.temp_qty <> f.formal_qty','【DRP监控】订单正式表与统一临时表明细数量不一致监控','【DRP监控】订单正式表与统一临时表明细数量不一致监控','liuchao@gigacloudtech.com,chenkailiang@gigacloudtech.com,liniannian@gigacloudtech.com','chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select ts.DisplayName                                                                               ''店铺名'',
...
order by twe.warehouseCode, ts.shipping_fee_type, tblo.createDate, tblo.PayPalTxID','【DRP-监控】合作仓订单超3天未推送','【DRP-监控】合作仓订单超3天未推送','liuchao@gigacloudtech.com,shishanshan@gigacloudtech.com','sujiawei@gigacloudtech.com,zhaijianfeng@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select distinct
                   ...
                   where  tblo.OrderStatus  = 2 and tblo.createDate>''2021-07-08 02:06:14.107''
                     and ta.carrier_service_level_code like ''%Overnight%'' and tblo.storeid in(205,212,276,277)','Being Process的Overnight订单','Being Process的Overnight订单','pingtaikefu@gigacloudtech.com','songyinghui@gigacloudtech.com,chenkailiang@gigacloudtech.com,liuchao@gigacloudtech.com,chenhuizhu@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tse.OrdersFrom,
       tul.orderId,
       max(convert(varchar, tul.creationdate, 20)) AS dealTime,
       ''Buy Fedex Label''                           AS workname,
       tul.errmessage,
...
where tul.worktype in (19)
  ...
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
  and isnull(tbs.isInvoicePrinted, 0) <> 1
group by tse.OrdersFrom, tul.orderId, tul.errmessage, toss.OrderStatus','【B2B-监控】【重要】FedEx、UPS、Amazon Buy Label 失败','【B2B-监控】【重要】FedEx、UPS、Amazon Buy Label 失败','pingtaikefu@gigacloudtech.com','chenkailiang@gigacloudtech.com,liuchao@gigacloudtech.com,uswhcoordinator@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('    select t.DisplayName                          "StoreName",
                       ...
                       from (select tse.DisplayName,
                             ...
                             group by tse.DisplayName,
                                     ...
                                     tbls.AssignedTo,
                                      tbls.ServiceLevel) t
                       order by t.createDate DESC','【DRP-监控】B2B LTL长期未发单','【DRP-监控】B2B LTL长期未发单','pingtaikefu@gigacloudtech.com,uswhcoordinator@gigacloudtech.com,wuyating@gigacloudtech.com,lunjia.li@gigacloudtech.com,logistics@gigacloudtech.com','liuchao@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select distinct
                                         ta.sales_order_number
                                     from tbl_item_code_attachment ta with(nolock)
                                              join tblorders tblo with(nolock) on ta.sales_order_number=tblo.PayPalTxID
                                     where  tblo.OrderStatus  = 2 and tblo.createDate>''2022-11-01 00:00:00.000''
                                       and ta.carrier_service_level_code like ''%Overnight%'' and tblo.storeid in(208);','Being Process的Overnight订单','Being Process的Overnight订单','shishanshan@gigacloudtech.com','songyinghui@gigacloudtech.com,chenkailiang@gigacloudtech.com,liuchao@gigacloudtech.com,chenhuizhu@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tblw.WarehouseCode                 ''From'',
       ''YiCang''                           ''To'',
...
order by tul.programCode desc, tuh.CREATIONDATE desc','【DRP-监控】【重要】外部仓库（易仓）对接订单异常','【DRP-监控】【重要】外部仓库（易仓）对接订单异常','shishanshan@gigacloudtech.com,shenling@gigacloudtech.com','drp_us_it@gigacloudtech.com,pingtaikefu@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tblw.WarehouseCode                 ''From'',
       ''YiCang''                           ''To'',
       case tul.programCode
           when ''1111'' then ''Fail''
...
where tul.hisId in (select top 1 header.hisId
  ...
  and tul.ERRMESSAGE not like ''%serviceType is null%''
  and tul.programCode != ''0000''
order by tul.programCode desc, tuh.CREATIONDATE desc','【DRP-监控】【重要】ATX4仓库（易仓）对接订单异常','【DRP-监控】【重要】ATX4仓库（易仓）对接订单异常','shishanshan@gigacloudtech.com,shenling@gigacloudtech.com,liuchao@gigacloudtech.com','drp_us_it@gigacloudtech.com,pingtaikefu@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES (' select  dealtime,workname,WORKCOUNT,OKCOUNT
from tuslogheader with(nolock) where workStatus in (2,4) and  (worktype in (49,51,52,53,58) or (WORKTYPE = 26 and storeid = 226)) ','【WOS-监控】【重要】云送仓接口调用异常','【WOS-监控】【重要】云送仓接口调用异常','songyinghui@gigacloudtech.com','liuchao@gigacloudtech.com,xiafei@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select ROW_NUMBER() OVER (ORDER BY temp.sales_order_number) as "No.",
...
from (select teso.sales_order_number,
      ...
      where operating_type in (20, 21)
        ...
        and tbo.OrderStatus not in (16, 32)) temp','【DRP-监控】卡车备货异常监控','【DRP-监控】卡车备货异常监控','songyinghui@gigacloudtech.com,shishanshan@gigacloudtech.com,uswhcoordinator@gigacloudtech.com','chenkailiang@gigacloudtech.com,chenhuizhu@gigacloudtech.com,liuchao@gigacloudtech.com,linda.xie@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select distinct tor.PayPalTxID     ''销售订单号'',
                                                      thi.item_code      ''冻结SKU'',
                                      ...
                                      order by tor.createDate DESC','new order订单有冻结库存','new order订单有冻结库存','songyinghui@gigacloudtech.com,zhangyumeng@gigacloudtech.com,chengguangkuo@gigacloudtech.com','chenkailiang@gigacloudtech.com,liuchao@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tbo.PayPalTxID,
       tbs.DisplayName,
       tos.OrderStatus,
...
where tbo.createDate >= getdate() - 5
  ...
  and tbs.StoreID in (300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 315, 316, 317,
                      ...
                      339, 340, 341,
                      342, 343, 344, 345, 346, 347, 348)','【DRP-监控】创建时间最近但是订单很早之前下单的订单','【DRP-监控】创建时间最近但是订单很早之前下单的订单','stella.cui@gigacloudtech.com,bonnie.lin@gigacloudtech.com','liuchao@gigacloudtech.com,sujiawei@gigacloudtech.com,zhaijianfeng@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('    select t.DisplayName                          "StoreName",
                                                                    t.warehouseCode                        "仓库CODE",
                                                                    t.PayPalTxID                           "销售订单号",
                                                                    t.createDate                           "订单进入系统的时间",
                                                             ...
                                                             order by t.createDate DESC ','【DRP-监控】自营 LTL长期未发单','【DRP-监控】自营 LTL长期未发单','suzhou_CSR@gigacloudtech.com,salesreport@gigacloudtech.com,uswhcoordinator@gigacloudtech.com,wuyating@gigacloudtech.com,lunjia.li@gigacloudtech.com,logistics@gigacloudtech.com','liuchao@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select t.DisplayName                          "StoreName",
                                                 t.warehouseCode                        "仓库CODE",
                                                 t.PayPalTxID                           "销售订单号",
                                                 t.createDate                           "订单进入系统的时间",
                                          ...
                                          order by t.createDate DESC','【DRP-监控】3PL LTL长期未发单','【DRP-监控】3PL LTL长期未发单','suzhou_CSR@gigacloudtech.com,uswhcoordinator@gigacloudtech.com,wuyating@gigacloudtech.com,lunjia.li@gigacloudtech.com,csr_giga@gigacloudtech.com','chenkailiang@gigacloudtech.com,liuchao@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select temp.DisplayName as "From",
...
order by temp.StoreID','FedEx、UPS、Amazon Buy Label失败','FedEx、UPS、Amazon Buy Label失败','US_yunying@gigacloudtech.com,suzhou_csr@gigacloudtech.com','chenhuizhu@gigacloudtech.com,liuchao@gigacloudtech.com,songyinghui@gigacloudtech.com,sujiawei@gigacloudtech.com,zhaijianfeng@gigacloudtech.com,liniannian@gigacloudtech.com,shiyuanyuan@gigacloudtech.com,chenkailiang@gigacloudtech.com,yuebeibei@gigacloudtech.com,uswhcoordinator@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select twe.warehouseCode                 as ''仓库code'',
...
order by twe.warehouseCode,totat.created_date_time asc','【DRP-监控】合作仓库超过3天未发货订单','【DRP-监控】合作仓库超过3天未发货订单','uswhcoordinator@gigacloudtech.com','liuchao@gigacloudtech.com,xiafei@gigacloudtech.com,chenhuizhu@gigacloudtech.com,shishuwen@gigacloudtech.com,wanyuanqi@gigacloudtech.com,yuebeibei@gigacloudtech.com,zhaijianfeng@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('SELECT IIF(tse.shipping_fee_type = ''pick_up_account_buy_fee'' OR tse.shipping_fee_type = ''pick_up_buyer_upload_fee'',
...
GROUP BY IIF(tse.shipping_fee_type = ''pick_up_account_buy_fee'' OR tse.shipping_fee_type = ''pick_up_buyer_upload_fee'',
             N''上门取货'', N''一件代发''), twe.warehousecode','【US_DRP】24小时内Roadie买单成功的发货单量统计','【US_DRP】24小时内Roadie买单成功的发货单量统计','wuyating@gigacloudtech.com,wang.xin@gigacloudtech.com','chenkailiang@gigacloudtech.com,aojieying@gigacloudtech.com,chenhuizhu@gigacloudtech.com,xiafei@gigacloudtech.com,chen-lin@gigacloudtech.com,melissal@gigacloudtech.com,wangyan_2@gigacloudtech.com,yuebeibei@gigacloudtech.com,yuanwen@gigacloudtech.com,zhanghanlin@gigacloudtech.com,lunjia.li@gigacloudtech.com,xuyifan@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tbo.from_system,
       tul.orderId,
       max(convert(varchar, tul.creationdate, 20)) AS dealTime,
       tul.errmessage,
       toss.OrderStatus
...
ORDER BY max(convert(varchar, tul.creationdate, 20))','【US_DRP】UPS Roadie Buy Label 失败','【US_DRP】UPS Roadie Buy Label 失败','wuyating@gigacloudtech.com,wang.xin@gigacloudtech.com,lishuai02@gigacloudtech.com,yanglina@gigacloudtech.com','chenkailiang@gigacloudtech.com,aojieying@gigacloudtech.com,chenhuizhu@gigacloudtech.com,xiafei@gigacloudtech.com,chen-lin@gigacloudtech.com,melissal@gigacloudtech.com,wangyan_2@gigacloudtech.com,yuebeibei@gigacloudtech.com,yuanwen@gigacloudtech.com,zhanghanlin@gigacloudtech.com,lunjia.li@gigacloudtech.com,xuyifan@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select toi.sales_order_number,
       tor.OrderID,
...
where toi.create_date_time > DATEADD(HOUR, -1, GETDATE())
  ...
  and (
    ...
    )','【取消超时】B2B调用DRP取消接口超时','【取消超时】B2B调用DRP取消接口超时','xiafei@gigacloudtech.com,liuchao@gigacloudtech.com','chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select toi.sales_order_number,
       tor.OrderID,
       convert(varchar(100), toi.create_date_time, 120),
       case
...
where toi.create_date_time > DATEADD(HOUR, -1, GETDATE())
  and toi.memo like N''%失败%''','【DRP-监控】B2B取消/拦截接口返回失败','【DRP-监控】B2B取消/拦截接口返回失败','xiafei@gigacloudtech.com,liuchao@gigacloudtech.com','chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select twe.warehouseCode,
       tse.DisplayName,
       tos.PayPalTxID,
       toss.OrderStatus,
       tod.ItemCode,
...
group by twe.warehouseCode,
         ...
         toss.OrderStatus,
         tod.ItemCode,
         tos.createDate','【DRP监控】Purolator快递订单数据统计','【DRP监控】Purolator快递订单数据统计','yanglina@gigacloudtech.com,wuyating@gigacloudtech.com,xukunming@gigacloudtech.com,wang.xin@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tse.OrdersFrom,
...
where tul.worktype in (19)
  ...
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
  and isnull(tbs.isInvoicePrinted, 0) <> 1
group by tse.OrdersFrom, tul.orderId, tul.errmessage, toss.OrderStatus','新【B2B-监控】【重要】FedEx、UPS、Amazon Buy Label 失败','新【B2B-监控】【重要】FedEx、UPS、Amazon Buy Label 失败','zhaijianfeng@gigacloudtech.com','chenkailiang@gigacloudtech.com,liuchao@gigacloudtech.com,shiyuanyuan@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tbll.sales_order_number,
       case
...
','新【WOS-监控】大健云buy label失败
','zhaijianfeng@gigacloudtech.com','liuchao@gigacloudtech.com,zhaijianfeng@gigacloudtech.com,liniannian@gigacloudtech.com,shiyuanyuan@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select tse.StoreID,
       tse.DisplayName,
       tbll.sales_order_number,
       max(convert(varchar, tbll.create_time, 20)) AS dealTime,
       case
...
where tul.worktype in (19)
  ...
  and tse.StoreID not in
      (300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 315, 316, 317, 318, 319, 320,
       ...
       342, 343, 344, 345, 346, 347, 348)
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.StoreID, tse.DisplayName, tul.orderId, tul.errmessage, tbo.OrderStatus','新FedEx、UPS、Amazon Buy Label失败','新FedEx、UPS、Amazon Buy Label失败','zhaijianfeng@gigacloudtech.com','liuchao@gigacloudtech.com,liniannian@gigacloudtech.com,shiyuanyuan@gigacloudtech.com,chenkailiang@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select
       tse.DisplayName,
       tbll.sales_order_number,
       max(convert(varchar, tbll.create_time, 20)) AS dealTime,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','新204【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','新204【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','zhaijianfeng@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select
       tse.DisplayName,
       tbll.sales_order_number,
       max(convert(varchar, tbll.create_time, 20)) AS dealTime,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','新205【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','新205【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','zhaijianfeng@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select
       tse.DisplayName,
       tbll.sales_order_number,
       max(convert(varchar, tbll.create_time, 20)) AS dealTime,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','新206【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','新206【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','zhaijianfeng@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select
       tse.DisplayName,
       tbll.sales_order_number,
       max(convert(varchar, tbll.create_time, 20)) AS dealTime,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','新207【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','新207【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','zhaijianfeng@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select
       tse.DisplayName,
       tbll.sales_order_number,
       max(convert(varchar, tbll.create_time, 20)) AS dealTime,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','新208【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','新208【Noble监控】【重要】FedEx、UPS Buy Label 失败 - DRP','zhaijianfeng@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
INSERT INTO sys_monitor_config (monitor_table_sql,monitor_subject,monitor_config_code,monitor_to,monitor_cc,monitor_text_template) VALUES ('select
       tse.DisplayName,
       tbll.sales_order_number,
       max(convert(varchar, tbll.create_time, 20)) AS dealTime,
...
where tul.worktype in (19)
  ...
  and isnull(tbs.isInvoicePrinted, 0) <> 1
  and tul.ERRMESSAGE not like N''message:The service is currently unavailable%''
group by tse.DisplayName, tul.orderId, tul.errmessage, toss.OrderStatus','新209【Noble监控】【重要】FedEx、UPS、Amazon Buy Label 失败 - DRP','新209【Noble监控】【重要】FedEx、UPS、Amazon Buy Label 失败 - DRP','zhaijianfeng@gigacloudtech.com','drp_us_it@gigacloudtech.com','')
