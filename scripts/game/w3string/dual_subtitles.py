...
def open_ui_dialog():
    ...
    base_language_combo = ttk.Combobox(
        window,
        values=[
            "ar",
            "br",
    ...
    folder_entry.insert(
        0, r"C:\Program Files (x86)\Steam\steamapps\common\The Witcher 3"
    )
    ...
    youtube_link = tk.Label(
        window,
        text="https://www.youtube.com/@maximumspoil2500",
        fg="blue",
        cursor="hand2",
    )
    ...
    youtube_link.bind(
        "<Button-1>",
        lambda e: window.clipboard_append("https://www.youtube.com/@maximumspoil2500"),
    )
            ...
            if os.path.exists(file) & os.path.exists(source_file):
                ...
                if not is_ok:
                    ...
                    if os.path.exists(source_file) & os.path.exists(target_file):
                        ...
                        merged_lines = merge_content(
                            source_file, target_file, should_merge
                        )
