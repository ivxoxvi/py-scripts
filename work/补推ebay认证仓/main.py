...
update_tblOrders_date_sql = construct_sql_update_tblOrders_date(old_create_date, '2025-06-02 22:40:11.340')
insert_ebay_auth_sql = construct_sql_insert_ebay_auth(tk_and_trans_and_item, on_and_tk, out_bound_date)
